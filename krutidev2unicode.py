...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', type = argparse.FileType('rb'), dest = 'input_file', help = 'Input File', default = sys.stdin)
    parser.add_argument('-o', '--output', type = argparse.FileType('wb'), dest = 'output_file', help = 'Output File', default = sys.stdout)
